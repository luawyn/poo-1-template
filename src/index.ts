...
app.get("/users", async (req: Request, res: Response) => {
  try {
    ...
    // conversao de dados que vem do banco de dados, pelo que foi feito no ts
    // questao de seguranca, pro frontend
...
app.post("/users", async (req: Request, res: Response) => {
  try {
    ...
    const newUser = new User(id, name, email, password, new Date().toISOString);
